...
public class DefaultJAgent implements JAgent {
    ...
    DefaultJAgent(String id, String name, String description, String instructions, ChatModel model,
                  List<ToolCallback> toolCallbacks, ExternalToolExecutor toolExecutor) {
    ...
    DefaultJAgent(Builder builder) {
        ...
        this.toolCallbacks = bridge.callbacks();
